...
def rerun_pro_eval_pipeline(already_finish_file_path:str,  csv_file_path:str):
...
def merge_domain_pro_results(jsonl_file_path:str, merge_result_file_path:str):
    domain_result_eval = {}
    with open(jsonl_file_path, "r") as f:
        for line in f:
            temp_result_eval = json.loads(line)
            domain_result_eval.update(temp_result_eval)

    with open(merge_result_file_path, "w") as f:
        f.write(json.dumps(domain_result_eval))
...
if __name__ == '__main__':
    ...
    output_file_path = '/home/zjlab/code/nlp/professional_eval/domain_pro_eval_result.jsonl'
    ...
    need_merge_file_path = '/home/zjlab/code/nlp/professional_eval/eval_result/domain_pro_result.jsonl'
    merged_file_path = '/home/zjlab/code/nlp/professional_eval/eval_result/merged_domain_result.json'
    #merge_domain_pro_results(need_merge_file_path, merged_file_path)
